...
class Charm(object):
    ...
    def __init__(self):
        ...
        if self.lib.name == 'cython':
            ...
            self.unpackMsg = self.lib.unpackMsgGeneral
            self.packMsgChannelOptim = self.lib.packMsgChannelOptim
            self.CkArraySendFastChannel = self.lib.CkArraySendFastChannel
    ...
    def getGPUDirectData(self, post_buffers, remote_bufs):
        # this future will only be satisfied when all buffers have been received
        return_fut = self.Future()
        self.lib.getGPUDirectData(post_buffers, remote_bufs, return_fut)
        return return_fut
